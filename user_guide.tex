...
%----------------------------------------------------------------------------------------
%	PARTS/CHAPTERS (following VIC-20 User Guide structure)
%----------------------------------------------------------------------------------------

% Chapter 1: Getting to Know Your Commander X16
\include{ch01_getting_to_know_commanderx16}

\cleardoublepage

% Chapter 2: Using the Screen and Keyboard
\include{ch02_using_screen_and_keyboard}

\cleardoublepage

% Chapter 3: Color and Graphics
\include{ch03_color_and_graphics}

\cleardoublepage

% Chapter 4: Animation
\include{ch04_animation}

\cleardoublepage

% Chapter 5: Sound and Music
\include{ch05_sound_and_music}

\cleardoublepage

% Chapter 6: Conversing with Your X16
\include{ch06_conversing_with_x16}

\cleardoublepage

% Chapter 7: Introduction to Programming
\include{ch07_introduction_to_programming}
...
\include{appendix/error_messages}

\include{appendix/sample_programs}
