%----------------------------------------------------------------------------------------
%	PART 0 - Setup (Introductory section before Chapter 1)
%----------------------------------------------------------------------------------------

% Following the VIC-20 User Guide structure where "Unpacking and Connecting"
% comes before the numbered chapters. This displays as Part 0 to indicate it's
% the introductory/setup section before Chapter 1 begins.

\setcounter{part}{-1}  % Start at -1 so this part becomes Part 0
...
If everything is working, you're all set!  Turn to Chapter 1 to begin your
...
exploring!  Turn the page to begin Chapter 1: Getting to Know Your Commander X16.
