...
%----------------------------------------------------------------------------------------
%	CHAPTER - What's Your Name?
%----------------------------------------------------------------------------------------

\chapter*{What's Your Name?}\index{INPUT}
\addcontentsline{toc}{chapter}{\protect\numberline{}What's Your Name?}
...
%----------------------------------------------------------------------------------------
%	CHAPTER - The INPUT Statement
%----------------------------------------------------------------------------------------

\chapter*{The INPUT Statement}\index{INPUT}
\addcontentsline{toc}{chapter}{\protect\numberline{}The INPUT Statement}
...
%----------------------------------------------------------------------------------------
%	CHAPTER - Introducing Variables
%----------------------------------------------------------------------------------------

\chapter*{Introducing Variables}\index{Variables}
\addcontentsline{toc}{chapter}{\protect\numberline{}Introducing Variables}
...
%----------------------------------------------------------------------------------------
%	CHAPTER - The GET Statement
%----------------------------------------------------------------------------------------

\chapter*{The GET Statement}\index{GET}
\addcontentsline{toc}{chapter}{\protect\numberline{}The GET Statement}
...
%----------------------------------------------------------------------------------------
%	CHAPTER - A Temperature Converter
%----------------------------------------------------------------------------------------

\chapter*{A Temperature Converter}\index{INPUT}
\addcontentsline{toc}{chapter}{\protect\numberline{}A Temperature Converter}
...
%----------------------------------------------------------------------------------------
%	CHAPTER - Choose a Number
%----------------------------------------------------------------------------------------

\chapter*{Choose a Number}
\addcontentsline{toc}{chapter}{\protect\numberline{}Choose a Number}
